...
```{r graf.gradbena.dovoljenja.regije, echo=FALSE, message=FALSE, error=FALSE, warning=FALSE, fig.align='center', fig.height=7, fig.cap='Graf gradbenih dovoljenj po regijah'}
